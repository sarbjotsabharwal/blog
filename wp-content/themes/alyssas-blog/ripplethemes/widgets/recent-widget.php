...
if (!class_exists('Alyssas_Blog_Recent_Post_Widget')) :
   
    class Alyssas_Blog_Recent_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title'      => esc_html__('Recent Posts','alyssas-blog'),
                'no_of_post' => 3,
                'show_date'  => 1,
        ...
        function __construct()
        {
            $opts = array(
                ...
                'description' => esc_html__('RP: Recent Post Widget', 'alyssas-blog'),
            );

            parent::__construct('alyssas_blog-recent-post', esc_html__('RP: Recent Post Widget', 'alyssas-blog'), $opts);
        }
     ...
     public function update( $new_instance, $old_instance ){
        ...
        public function form($instance ){
          ...
          ?>
          <p>
                <label for="<?php echo esc_attr( $this->get_field_id('title') ); ?>"><strong><?php _e( 'Title', 'alyssas-blog' ); ?></strong></label><br />
             ...
             <p>
                 <label for="<?php echo $this->get_field_id('no_of_post'); ?>"><strong><?php _e( 'Number of posts to show:', 'alyssas-blog' ); ?></strong></label><br />
              ...
              <p>
                ...
                <label for="<?php echo  esc_attr( $this->get_field_id( 'active_slider' ) ); ?>"><strong><?php echo esc_html__( 'Show Post Date' ,'alyssas-blog'); ?></strong></label>
...
add_action( 'widgets_init', 'Alyssas_Blog_Recent_Post_Widget' ); 
function Alyssas_Blog_Recent_Post_Widget(){     
