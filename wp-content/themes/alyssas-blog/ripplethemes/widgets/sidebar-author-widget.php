...
class Alyssas_Blog_Author_Widget extends WP_Widget
{
     public function __construct()
     {
          parent::__construct(
               'sidebar-author-widget',
               __( 'RP: Sidebar Author Widget', 'alyssas-blog' ),
...
add_action( 'widgets_init', 'Alyssas_Blog_Author_Widget' ); 
function Alyssas_Blog_Author_Widget(){     
